...
public class GeothermalBoilerGUI extends SimpleMachineGUI{
	...
	public GeothermalBoilerGUI() {
		super(
				new ResourceLocation(SteamAdvantage.MODID+":textures/gui/container/geothermal_boiler.png"), 
				new Integer2D[0] 
		);
	}
...
guiContainer.drawTexturedModalRect(x+79, y+35, 0, 0, arrowLength, 17); // x, y, textureOffsetX, textureOffsetY, width, height)
	...
	public void drawGUIDecorations(Object srcEntity, GUIContainer guiContainer, int x, int y, float  z){
		...
		if(srcEntity.getClass() == GeothermalBoilerTileEntity.class){
			GeothermalBoilerTileEntity target = (GeothermalBoilerTileEntity)srcEntity;
			...
			GUIHelper.drawNeedle(x+leftPivotX, y+leftPivotY, z, temp);
