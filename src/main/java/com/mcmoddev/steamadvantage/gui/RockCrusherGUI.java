...
public class RockCrusherGUI extends SimpleMachineGUI{
	...
	public RockCrusherGUI() {
		super(
				new ResourceLocation(SteamAdvantage.MODID+":textures/gui/container/rock_crusher.png"), 
				Integer2D.fromCoordinates(44,19, 44,88, 62,88, 80,88, 98,88, 116,88)
		);
	}
...
guiContainer.drawTexturedModalRect(x+79, y+35, 0, 0, arrowLength, 17); // x, y, textureOffsetX, textureOffsetY, width, height)
	...
	public void drawGUIDecorations(Object srcEntity, GUIContainer guiContainer, int x, int y, float  z){
		...
		if(srcEntity.getClass() == RockCrusherTileEntity.class){
			RockCrusherTileEntity target = (RockCrusherTileEntity)srcEntity;
